...
List
<Store> storeList = new ArrayList<>(); storeList = (List<Store>)session.getAttribute("storeList");
%> <!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<form action="UserController" method="get">
		<input type="checkbox" name="course" value="60">60分コース <input
			...
			<% } %>
		</select> <input type="submit" value="送信"> <input type="hidden"
			name="command" value="Seat">
	</form>
